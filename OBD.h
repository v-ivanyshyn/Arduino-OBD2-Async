...
public:
	...
	*/
	...
	virtual bool isValidPID(byte pid);
        ...
        // async requesting data:
        virtual void asyncRequest(byte pid);
        virtual bool asyncInProgress();
        virtual bool asyncGet(int& result);
        virtual int asyncDuration();
...
protected:
	...
	OBD_STATES m_state;
        ...
        int aTimestamp;
        int aBufferN;
        char aBuffer[OBD_RECV_BUF_SIZE];
private:
